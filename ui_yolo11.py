...
################################################################################
## Form generated from reading UI file 'yolo11urZCoh.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_7.setGeometry(QRect(10, 174, 121, 18))
        self.lineEdit_2 = QLineEdit(self.frame)
        self.lineEdit_2.setObjectName(u"lineEdit_2")
        self.lineEdit_2.setGeometry(QRect(132, 170, 40, 26))
        self.label_8 = QLabel(self.frame)
        self.label_8.setObjectName(u"label_8")
        self.label_8.setGeometry(QRect(10, 204, 121, 18))
        self.lineEdit_3 = QLineEdit(self.frame)
        self.lineEdit_3.setObjectName(u"lineEdit_3")
        self.lineEdit_3.setGeometry(QRect(132, 200, 40, 26))
        self.label_9 = QLabel(self.frame)
        self.label_9.setObjectName(u"label_9")
        self.label_9.setGeometry(QRect(10, 234, 121, 18))
        self.lineEdit_4 = QLineEdit(self.frame)
        self.lineEdit_4.setObjectName(u"lineEdit_4")
        self.lineEdit_4.setGeometry(QRect(132, 230, 41, 26))
        self.label_10 = QLabel(self.frame)
        self.label_10.setObjectName(u"label_10")
        self.label_10.setGeometry(QRect(10, 264, 121, 18))
        self.lineEdit_5 = QLineEdit(self.frame)
        self.lineEdit_5.setObjectName(u"lineEdit_5")
        self.lineEdit_5.setGeometry(QRect(132, 260, 41, 26))
        self.lineEdit_6 = QLineEdit(self.frame)
        self.lineEdit_6.setObjectName(u"lineEdit_6")
        self.lineEdit_6.setGeometry(QRect(132, 290, 41, 26))
        self.label_11 = QLabel(self.frame)
        self.label_11.setObjectName(u"label_11")
        self.label_11.setGeometry(QRect(8, 294, 121, 18))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(QCoreApplication.translate("MainWindow", u"DS_NMS_THRESH", None))
        self.lineEdit_2.setText(QCoreApplication.translate("MainWindow", u"0.45", None))
        self.label_8.setText(QCoreApplication.translate("MainWindow", u"DS_OBJ_THRESH", None))
        self.lineEdit_3.setText(QCoreApplication.translate("MainWindow", u"0.25", None))
        self.label_9.setText(QCoreApplication.translate("MainWindow", u"PO_NMS_THRESH", None))
        self.lineEdit_4.setText(QCoreApplication.translate("MainWindow", u"0.4", None))
        self.label_10.setText(QCoreApplication.translate("MainWindow", u"PO_OBJ_THRESH", None))
        self.lineEdit_5.setText(QCoreApplication.translate("MainWindow", u"0.5", None))
        self.lineEdit_6.setText(QCoreApplication.translate("MainWindow", u"300", None))
        self.label_11.setText(QCoreApplication.translate("MainWindow", u"MAX_DETECT", None))
